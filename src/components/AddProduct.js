...
const AddProduct = () => {
	...
	return (
		<div className="AddProduct w-full md:w-1/2 lg:w-1/4 m-auto p-4 md:p-0 fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col justify-center items-center gap-8">
